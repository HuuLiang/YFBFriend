...
-(UIImage *)getSubImage{
    ...
    UIImage* smallImage = [UIImage imageWithCGImage:subImageRef scale:self.originalImage.scale orientation:self.originalImage.imageOrientation];
    UIGraphicsEndImageContext();
//    return [self fixrotation:smallImage];
    return smallImage;
}
